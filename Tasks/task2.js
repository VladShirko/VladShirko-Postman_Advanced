...
const smallPlanets = extractSmallPlanets(planets, 10000);
console.log('Small planets:',smallPlanets);

const BigPlanets = extractBigPlanets(planets, 10000);
console.log('Big planets:',BigPlanets);